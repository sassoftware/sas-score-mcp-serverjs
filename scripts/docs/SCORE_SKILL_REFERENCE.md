...
## Supported Types
- **job** â€” Route to `job-score` for job-based scoring
- **jobdef** â€” Route to `jobdef-score` for job definition-based scoring
- **mas** â€” Route to `mas-score` (Model Aggregation Service)
- **scr** â€” Route to `scr-score` (Score Code Runtime container)
- **sas** â€” Route to `program-score` (arbitrary SAS/SQL scoring)
