...
async function callback(req, res, pkceStore, codeStore, baseAppEnvContext) {
  console.error("===============================================================");
  ...
  const callbackUri = `${baseUrl(baseAppEnvContext)}/callback`;
  ...
  try {
    ...
    let connectOpts = {
      ca: baseAppEnvContext.contexts.viyaCert.ca,     // trust this CA
    ...
    let clientID= baseAppEnvContext.CLIENTID;
